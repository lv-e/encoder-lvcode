...
let encode = {
    declarations: ((_a = data.body.declarations) === null || _a === void 0 ? void 0 : _a.code) || "",
    on_awake: ((_b = data.body.on_awake) === null || _b === void 0 ? void 0 : _b.code) || "",
    on_enter: ((_c = data.body.on_enter) === null || _c === void 0 ? void 0 : _c.code) || "",
    on_frame: ((_d = data.body.on_frame) === null || _d === void 0 ? void 0 : _d.code) || "",
    on_exit: ((_e = data.body.on_exit) === null || _e === void 0 ? void 0 : _e.code) || "",
    globals: ((_f = data.body.globals) === null || _f === void 0 ? void 0 : _f.code) || "",
};
